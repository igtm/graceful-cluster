...
/*
 ...
 - options.workerProcessShutdownTimeout  - worker process force showdown timeout.
    ...
    if (cluster.isMaster) {
        ...
        process.on('message', (msg) => {
            if (msg === 'restart') {
                ...
                const checkIfServerConnIsZenoTimerID = setTimeout(function() {
                ...
                const disconnectProcessTimerID =  setTimeout(function() {
                  clearTimeout(checkIfServerConnIsZenoTimerID);
                  forceExitTimer();
                  cluster.worker.disconnect();
                }, workerProcessShutdownTimeout);
            }
